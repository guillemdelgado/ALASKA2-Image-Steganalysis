...
# Decide if doing oversampling or undersampling
train_gen = DataGenerator(IMAGE_IDS_train, IMAGE_LABELS_train, batch_size=2, shuffle=True)
validation_gen = DataGenerator(IMAGE_IDS_val, IMAGE_LABELS_val, batch_size=2)
